...
[3:2]  | select the time stamp format
  ...
  \e   | 1 - standard time stamp as Unix epoch in s.Âµs
  \e   | 2 - absolute time as of start of the system in s.Âµs
  \e   | 3 - relative time to the previous received frame  in s.Âµs
...
*
* FÃ¼r Windows wird diese Funktion von der Applikation aufgerufen.
**********************************************************/
